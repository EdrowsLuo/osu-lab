...
@Deprecated
public class LegacyTexture3DShader extends ColorShader {
    public static LegacyTexture3DShader Invalid = new InvalidLegacyTexture3DShader();

    public static final Lazy<LegacyTexture3DShader> DEFAULT;

    static {
        DEFAULT = Lazy.create(() -> new LegacyTexture3DShader(
    ...
    protected LegacyTexture3DShader(GLProgram program) {
        super(program, true);
    }

    protected LegacyTexture3DShader(GLProgram p, boolean i) {
        super(p, i);
    }
    ...
    public static final LegacyTexture3DShader createT3S(String vs, String fs) {
        LegacyTexture3DShader s = new LegacyTexture3DShader(GLProgram.createProgram(vs, fs));
        return s;
    }

    public static class InvalidLegacyTexture3DShader extends LegacyTexture3DShader {
        public InvalidLegacyTexture3DShader() {
